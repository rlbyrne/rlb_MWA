...
def plot_maps_Sept2():
    ...
    sourcedir = '/Users/rubybyrne/diffuse_survey_plotting_Jun2021'
    outdir = '/Users/rubybyrne/diffuse_survey_plotting_Sept2021'
    nsamples_map = healpix_utils.load_map(
        '{}/nsamples_map.fits'.format(sourcedir)
    )
    plot_healpix_map.plot_filled_pixels(
        nsamples_map,
    ...
    weights_map = healpix_utils.load_map(
        '{}/weights_map.fits'.format(sourcedir)
    )
    plot_healpix_map.plot_filled_pixels(
        weights_map,
...
def estimate_pol_leakage_Sept15():
    ...
    averaged_maps, weights_maps = healpix_utils.average_healpix_maps(
        ...
        weighting='optimal',
        apply_rm_correction=False,
        restore_from_sav=True,
        sav_file_path='/Users/rubybyrne/polarization_leakage/pol_leakage_Jun2021/healpix_leakage_maps'
    )
    ...
    for pol_ind, pol_name in enumerate(pols):
        averaged_maps[pol_ind].write_data_to_fits(
            '{}/Stokes{}_leakage_map.fits'.format(outdir, pol_name)
        )
    for pol_ind, pol_name in enumerate(pols):
        plot_healpix_map.plot_filled_pixels(
            averaged_maps[pol_ind],
            '{}/Stokes{}_leakage_map.png'.format(outdir, pol_name),
            colorbar_range=[0, .4], colorbar_label='Fractional Leakage Fit',
