    ...
    for group_ind, group in enumerate(obs_groups):
        ...
        for map_ind in range(len(combined_maps)):
            ...
            combined_maps[map_ind].write_data_to_fits(
                '/Users/rubybyrne/diffuse_survey_plotting_May2020/eor0_plots/Stokes{}_eor0_map{}_no_rm_correction.fits'.format(pol, group_ind+1)
            )
            if pol == 'I':
                colorbar_range = [-1e4, 1e4]
            else:
            ...
            plot_healpix_map.plot_filled_pixels(
                ...
                '/Users/rubybyrne/diffuse_survey_plotting_May2020/eor0_plots/Stokes{}_eor0_map{}_no_rm_correction.png'.format(pol, group_ind+1),
                colorbar_range=colorbar_range
            )
