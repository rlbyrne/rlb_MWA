...
PRO var_compare_scatter_plot, choose_term = choose_term, $
  ...
  IF KEYWORD_SET(savefile) THEN CGPS_OPEN, '/nfs/eor-00/h1/rbyrne/MWA/rlb_MWA/error_analysis/varcompare_scatter_'+cube_name+'_'+polarization+'_term' + STRTRIM(STRING(choose_term), 2), $
